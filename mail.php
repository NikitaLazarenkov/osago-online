...
$msg='Заявка на оформление ОСАГО';
$msg.='IP Adress: ';
...
$msg.='Итого с оформлением полиса ОСАГО (+ от 1000 рублей за услуги): '.$_POST['send_summ2'].'<br>';

$msg='Данные для Диагностической карты';
...
$msg.='Стоимость полиса ОСАГО с оформлением диагностической карты + (1000 рублей за услуги) по предварительному расчёту составит: '.$_POST['send_summ3'].'<br>';

$msg.='Выберете способ получения полиса: '.$_POST['send_dostavka'].'<br>';
